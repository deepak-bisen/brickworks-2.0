package com.brickwork.orders.order.controller;
...
public interface OrderController {
     ...
     */
    @PostMapping("/create")
    ResponseEntity<?> createOrder(@Valid @RequestBody OrderRequestDTO orderRequestDTO);
    ...
    @GetMapping("/all/get/public-quote")
